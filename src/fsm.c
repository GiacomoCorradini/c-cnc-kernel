...
Generation date: 2022-05-19 13:18:52 +0200
...
const char *ccnc_state_names[] = {"init", "idel", "load_block", "stop", "no_motion", "rapid_motion", "interp_motion"};

// List of state functions
state_func_t *const ccnc_state_table[CCNC_NUM_STATES] = {
  ccnc_do_init,          // in state init
  ccnc_do_idel,          // in state idel
...
transition_func_t *const ccnc_transition_table[CCNC_NUM_STATES][CCNC_NUM_STATES] = {
  /* states:           init      , idel      , load_block, stop      , no_motion , rapid_motion, interp_motion */
  /* init          */ {NULL      , NULL      , NULL      , NULL      , NULL      , NULL      , NULL      }, 
  /* idel          */ {NULL      , NULL      , ccnc_reset, NULL      , NULL      , NULL      , NULL      }, 
  /* load_block    */ {NULL      , NULL      , NULL      , NULL      , NULL      , NULL      , NULL      }, 
  /* stop          */ {NULL      , NULL      , NULL      , NULL      , NULL      , NULL      , NULL      }, 
  /* no_motion     */ {NULL      , NULL      , NULL      , NULL      , NULL      , NULL      , NULL      }, 
  /* rapid_motion  */ {NULL      , NULL      , ccnc_reset, NULL      , NULL      , NULL      , NULL      }, 
  /* interp_motion */ {NULL      , NULL      , ccnc_reset, NULL      , NULL      , NULL      , NULL      }, 
};
...
// valid return states: CCNC_STATE_IDEL
ccnc_state_t ccnc_do_init(ccnc_state_data_t *data) {
  ccnc_state_t next_state = CCNC_STATE_IDEL;
  signal(SIGINT, signal_handler); 
  
  /* Your Code Here */
  
  switch (next_state) {
    case CCNC_STATE_IDEL:
      break;
    default:
...
// Function to be executed in state idel
// valid return states: CCNC_NO_CHANGE, CCNC_STATE_IDEL, CCNC_STATE_LOAD_BLOCK, CCNC_STATE_STOP
// SIGINT triggers an emergency transition to stop
ccnc_state_t ccnc_do_idel(ccnc_state_data_t *data) {
...
// valid return states: CCNC_STATE_NO_MOTION, CCNC_STATE_RAPID_MOTION, CCNC_STATE_INTERP_MOTION, CCNC_STATE_STOP
ccnc_state_t ccnc_do_load_block(ccnc_state_data_t *data) {
  ccnc_state_t next_state = CCNC_STATE_NO_MOTION;
...
// 1. from idel to load_block
// 2. from rapid_motion to load_block
// 3. from interp_motion to load_block
